...
import com.example.jinxiMall.Repository.*;
...
public class OrderController {
    ...
    private String createProductSnaps(List<OrderForm> orderMsg, Long orderId) throws ItemNotFoundException, InventoryOutOfBoundException {
        for (OrderForm msg : orderMsg) {
    ...
    private void lockInventories(List<OrderForm> orderMsg) {
        for (OrderForm msg : orderMsg) {
